...
extern "C" PUB BOOL WINAPI CoreDllMain(HANDLE hInstance, DWORD dwReason, LPVOID lpReserved)
{
...
extern "C"
PUB BOOL WINAPI DllMain(HANDLE hInstance, DWORD dwReason, LPVOID lpReserved)
{
    STATIC_CONTRACT_NOTHROW;
...
// ---------------------------------------------------------------------------
PUB STDAPI  GetMetaDataInternalInterface(
...
// scopeless interface.
// ---------------------------------------------------------------------------
PUB STDAPI  GetMetaDataInternalInterfaceFromPublic(
...
// scopeless interface.
// ---------------------------------------------------------------------------
PUB STDAPI  GetMetaDataPublicInterfaceFromInternal(
