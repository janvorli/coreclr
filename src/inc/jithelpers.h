...
// It will be set in InitJITHelpers2
    ...
    DYNAMICJITHELPER(CORINFO_HELP_ASSIGN_REF,   JIT_WriteBarrier_Template,   CORINFO_HELP_SIG_NO_ALIGN_STUB)
    DYNAMICJITHELPER(CORINFO_HELP_CHECKED_ASSIGN_REF, JIT_CheckedWriteBarrier_Template,CORINFO_HELP_SIG_NO_ALIGN_STUB)
